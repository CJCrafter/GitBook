...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name.set("GitBook Java API")
                description.set("Access GitBook's API without the raw JSON/HTTPS requests")
                url.set("https://github.com/CJCrafter/GitBook")
                ...
                scm {
                    connection.set("scm:git:https://github.com/CJCrafter/GitBook.git")
                    developerConnection.set("scm:git:ssh://github.com/CJCrafter/GitBook.git")
                    url.set("https://github.com/CJCrafter/GitBook")
                }
            }
        }
...
```groovy
dependencies {
    implementation 'com.cjcrafter:gitbook:$version'
}
```
...
```
See the [maven repository](https://central.sonatype.com/artifact/com.cjcrafter/gitbook/$version) for gradle/ant/etc.
    """.trimIndent())
    overwrite.set(false)
